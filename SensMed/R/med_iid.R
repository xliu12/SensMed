...
Med3 <- function(
  ...
  m_each_Mjo <- list(
    ...
    a_mc <- a.mc(med, folds, learners_treatment, control, covariates_cl = FALSE)
    ...
    alphas_each_IIE_Mjo <- riesz_crossfit(med, m_each = m_each_Mjo[c(1:2)], folds, which.M = NULL, learners_riesz = control$learners_riesz, control, riesz_alpha1 = F, riesz_alpha3 = F, alpha_ac, a_c, a_mc, covariates_cl = F)

    alphas_each_IDE <- riesz_crossfit(med, m_each = m_each_Mjo[c(3:4)], folds, which.M = NULL, learners_riesz = control$learners_riesz, control, riesz_alpha1 = F, riesz_alpha3 = F, alpha_ac, a_c, a_mc, covariates_cl = F)
    ...
    if (IIE_each) {
        ...
        # m_each_Mjo <- list(
        #   IIE_Mjo_m = c(az = "data_0", am = "data_0", ay = "data_1"),
        #   IIE_Mjo_p = c(az = "data_1", am = "data_1", ay = "data_1"),
        #   IDE_m = c(az = "data_0", am = "data_0", ay = "data_0"),
        #   IDE_p = c(az = "data_0", am = "data_0", ay = "data_1")
        # )
        # IIE_M1, independently draw M2 from its marginal distribution
        med <- add_indepM(med, control, which.M = c(1:num_M)[-1], cwc = F)
        med1 <- med
        ...
        med2 <- add_indepM(med, control, which.M = c(1:num_M)[-2], cwc = F)
        m_each_IIE_M2 <- list(
