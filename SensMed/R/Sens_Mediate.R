...
Sens.Mediate <- function(
    ...
    if (!is.null(benchmark_covariates)) {
        if (!is.null(long_mus_IIE)) {
            ...
            emp_sensparams <- empirical.sensparams(short_list)

            sens_IIE$sens_estimates <- sens_IIE$sens_estimates %>%
                mutate(cf.m1_emp = emp_sensparams$cf.m_IIE[1],
                       cf.m2_emp = emp_sensparams$cf.m_IIE[2],

                       cf.y1_emp = emp_sensparams$cf.y_IIE[1],
                       cf.y2_emp = emp_sensparams$cf.y_IIE[2],

                       rho21 = emp_sensparams$rho2_IIE[1],
                       rho22 = emp_sensparams$rho2_IIE[2],

                       interpretCalpha1 = emp_sensparams$interpretCalphas_IIE[1],
                       interpretCalpha2 = emp_sensparams$interpretCalphas_IIE[2],

                       interpretCtheta1 = emp_sensparams$interpretCthetas_IIE[1],
                       interpretCtheta2 = emp_sensparams$interpretCthetas_IIE[2],

                       interpretRho22 = emp_sensparams$interpretRho22_IIE
                )

            sens_IDE$sens_estimates <- sens_IDE$sens_estimates %>%
                mutate(cf.m1_emp = emp_sensparams$cf.m_IDE[1],
                       cf.m2_emp = emp_sensparams$cf.m_IDE[2],

                       cf.y1_emp = emp_sensparams$cf.y_IDE[1],
                       cf.y2_emp = emp_sensparams$cf.y_IDE[2],

                       rho21 = emp_sensparams$rho2_IDE[1],
                       rho22 = emp_sensparams$rho2_IDE[2],

                       interpretCalpha1 = emp_sensparams$interpretCalphas_IDE[1],
                       interpretCalpha2 = emp_sensparams$interpretCalphas_IDE[2],

                       interpretCtheta1 = emp_sensparams$interpretCthetas_IDE[1],
                       interpretCtheta2 = emp_sensparams$interpretCthetas_IDE[2],

                       interpretRho22 = emp_sensparams$interpretRho22_IDE)
